          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              delay: 0.3
                ...
                <Button size="xl" className="btn-glow bg-accent hover:bg-accent/90 text-white rounded-full px-8 h-14 text-base font-medium" onClick={() => document.getElementById('contact')?.scrollIntoView({
                behavior: 'smooth'
              })}>
                  Обсудить проект
                  <ArrowRight className="w-5 h-5 ml-2" />
                </Button>
                <Button variant="outline" size="xl" className="rounded-full px-8 h-14 border-border/50 hover:border-accent/50 hover:bg-accent/5 group" asChild>
                  <a href="#cases">
            ...
            delay: 0.3
              ...
              <div className="glass-card p-8 mb-6 animate-glow-pulse">
                ...
                <div className="text-muted-foreground">успешно открученного бюджета за 2025</div>
              </div>
              ...
              <div className="absolute -bottom-8 -left-8 w-32 h-32 bg-orange-500/10 rounded-full blur-3xl animate-float" style={{
              animationDelay: '2s'
            }} />
            </motion.div>
          </div>
