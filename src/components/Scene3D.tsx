    ...
    <Float speed={1.5} rotationIntensity={0.2} floatIntensity={0.5}>
      <group ref={groupRef} position={position} scale={scale}>
        ...
        <RoundedBox args={[1.2, 1.2, 0.25]} radius={0.15} smoothness={4}>
          <meshStandardMaterial color="#dc2626" roughness={0.2} metalness={0.8} emissive="#dc2626" emissiveIntensity={0.3} />
        </RoundedBox>
        {/* Letter "f" */}
    ...
    <Float speed={1.8} rotationIntensity={0.25} floatIntensity={0.6}>
      <group ref={groupRef} position={position} scale={scale}>
        ...
        <RoundedBox args={[1.2, 1.2, 0.25]} radius={0.25} smoothness={4}>
          <meshStandardMaterial color="#ff4444" roughness={0.2} metalness={0.8} emissive="#ff4444" emissiveIntensity={0.3} />
        </RoundedBox>
        {/* Camera lens circle */}
    ...
    <Float speed={1.4} rotationIntensity={0.2} floatIntensity={0.5}>
      <group ref={groupRef} position={position} scale={scale}>
        ...
        <RoundedBox args={[1.6, 1.1, 0.25]} radius={0.2} smoothness={4}>
          <meshStandardMaterial color="#dc2626" roughness={0.2} metalness={0.8} emissive="#dc2626" emissiveIntensity={0.35} />
        </RoundedBox>
        {/* Play triangle */}
    ...
    <Float speed={1.6} rotationIntensity={0.3} floatIntensity={0.6}>
      <group ref={groupRef} position={position} scale={scale}>
        ...
        <mesh>
          ...
          <meshStandardMaterial color="#ff6b35" roughness={0.2} metalness={0.8} emissive="#ff6b35" emissiveIntensity={0.3} />
        </mesh>
        {/* Paper plane */}
    ...
    <Float speed={1.7} rotationIntensity={0.25} floatIntensity={0.55}>
      <group ref={groupRef} position={position} scale={scale}>
        ...
        <RoundedBox args={[1.1, 1.3, 0.25]} radius={0.18} smoothness={4}>
          <meshStandardMaterial color="#ff3333" roughness={0.2} metalness={0.8} emissive="#ff3333" emissiveIntensity={0.3} />
        </RoundedBox>
        {/* Music note stem */}
  ...
  return (
    <div className="absolute inset-0 z-0">
      ...
      >
        ...
        <pointLight position={[-8, -6, -5]} intensity={0.7} color="#dc2626" distance={20} />
